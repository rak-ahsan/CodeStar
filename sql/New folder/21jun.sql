...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2023 at 08:12 PM
...
(1, 'dhaka', '80000', 'Rico Suarez', 1, 1, 6, '2023-06-20 22:14:19'),
(2, 'mirpur', '100000', 'Jorge', 1, 2, 8, '2023-06-20 22:14:43'),
(3, 'samoli', '50000', 'adam', 2, 1, 8, '2023-06-20 22:15:11');
...
(9, 'pial', 120000, 1, 6, '', '2023-06-20'),
(10, 'abc', 5000, 2, 6, '', '2023-06-20');
...
(11, 'wsc', 2, '74512', 9654, 1, 2),
(12, 'dream house ', 3, '48000000', 1000000, 1, 1),
(13, 'lmc', 2, '74512', 1000000, 1, 3);
...
--
ALTER TABLE `instalment`
  MODIFY `instal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
