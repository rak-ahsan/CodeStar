...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2023 at 08:36 AM
...
INSERT INTO `booking` (`bking_id`, `bkng_area`, `bkng_cost`, `bkng_name`, `bt_id`, `Payment`, `property_id`, `date`) VALUES
(1, 'dhaka', '80000', 'Rico Suarez', 2, 1, 1, '2023-06-20 18:00:00'),
(2, 'dhaka', '80000', 'Rico Suarez', 2, 2, 1, '2023-06-20 18:00:00'),
(3, 'barisal', '90000', 'jahangir', 1, 1, 6, '2023-06-20 18:00:00'),
(5, 'mirpur', '701000', 'tanvir', 1, 1, 2, '2023-06-22 06:13:35'),
(6, 'jurain', '5000', 'bisty', 2, 1, 8, '2023-06-22 06:15:39');
...
(9, 'jahangir', 500, 1, 1, '', '2023-06-20'),
(10, 'bisty', 600, 3, 1, '', '2023-06-20'),
(12, 'tanvir', 400, 1, 9, '', '2023-06-22');
...
--
-- Table structure for table `land_agent_property_view`
--
...
(9, ' suprim', 0, '82000', 900, 1, 0),
(10, '   uiykh', 2, '82000', 900, 2, 2),
(11, 'orc', 4, '5000', 500, 2, 1),
(13, ' orc', 2, '5000', 500, 1, 2);
...
--
-- Table structure for table `running_pj`
--
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `availablepro`  AS SELECT `property`.`property_id` AS `property_id`, `property`.`property_name` AS `property_name`, `property`.`property_location` AS `property_location`, `property`.`property_cost` AS `property_cost`, `property`.`land_img` AS `land_img`, `property`.`ls_id` AS `ls_id` FROM `property` WHERE `property`.`ls_id` = 11111111  ;
...
ALTER TABLE `booking`
  ...
  ADD UNIQUE KEY `bking_id` (`bking_id`);
...
ALTER TABLE `instalment`
  ...
  ADD UNIQUE KEY `instal_id` (`instal_id`);
...
ALTER TABLE `land_agent`
  ...
  ADD UNIQUE KEY `land_agent_id` (`land_agent_id`);
...
ALTER TABLE `metarial`
  ...
  ADD UNIQUE KEY `metarial_id` (`metarial_id`);
...
--
ALTER TABLE `booking`
  MODIFY `bking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `instalment`
  MODIFY `instal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `project`
  ADD CONSTRAINT `project_ibfk_1` FOREIGN KEY (`pc_id`) REFERENCES `p_contactor` (`land_agent_id`);

--
-- Constraints for table `property`
--
ALTER TABLE `property`
  ADD CONSTRAINT `property_ibfk_1` FOREIGN KEY (`ls_id`) REFERENCES `land_status` (`ls_id`),
  ADD CONSTRAINT `property_ibfk_2` FOREIGN KEY (`property_location`) REFERENCES `area` (`area_id`);
COMMIT;
