...
<div class="col-md-12 container d-flex justify-content-center bg">
  ...
  <div>
    ...
    <div >
      ...
      <input type="text" class="form-control mb-1 in" id="larea" name="selling_p" value="<?= $row['selling_p']?>">
    </div>
...
if(isset($_POST['sub'])){
  ...
  $sql = "UPDATE property SET property_name='$pname', property_location='$plocetion',selling_p='$selling_p' , property_cost='$pcost' ,
